...
def nearby(request):
    return render(request,'hospital/nearby.html')
...
#---------------------------------------------------------------------------------
def dd(request):
    return render(request, 'hospital/diseasediagnosis.html')
...
def result(request):
    ...
    input_vector[symp] = 1
    x=loaded_model.predict([input_vector])
    z=x[0]
    print(z)
    return render(request,'hospital/diseasediagnosis.html',{"ans":z,"symptoms":symptoms})
